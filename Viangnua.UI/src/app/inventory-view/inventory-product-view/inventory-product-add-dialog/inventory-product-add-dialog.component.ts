...
@Component({
  ...
  templateUrl: './inventory-product-add-dialog.component.html',
  styleUrl: './inventory-product-add-dialog.component.scss'
})
export class InventoryProductAddDialogComponent implements OnInit {
  ...
  constructor(private dialogRef: MatDialogRef<InventoryProductAddDialogComponent>, private fb: FormBuilder) {}
